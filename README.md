...
![DNB-Hugo/TESTCONTENT](.github/github-card-dark.png#gh-dark-mode-only)
![DNB-Hugo/TESTCONTENT](.github/github-card-light.png#gh-light-mode-only)

<!--- CARD END --->

# David's Neighbour GoHugo Component / Testcontent
...
| [hugo-netlification](https://github.com/davidsneighbour/hugo-netlification) | a collection of tools that optimise your site on Netlify |
